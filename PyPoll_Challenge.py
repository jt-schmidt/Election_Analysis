...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # count does not match any existing county in the county
...
with open(file_to_save, "w") as txt_file:
    ...
    largest_county_summary = (
        ...
        f"Largest County Turnout Percentage: {largest_county_percentage:.1f}%\n"
        f"-------------------------\n")
    print(largest_county_summary)
        
    candidate_header = (f"Candidate Votes:")
